...
parser.add_argument('--mix_files', type=str, default="data/SRR6756025.fastq,data/SRR6756028.fastq", help='files to be mixed, separated by ","')
parser.add_argument('--output_file', type=str, default="output.fastq", help='output file')
parser.add_argument('--contamination_length', type=float, default=0.1, help='number of bases changed')
parser.add_argument('--number_of_reads', type=int, default=1000, help='total number of reads')
...
def prepare_mix():
    mix_filenames = args.mix_files.split(",")
